...
class OneSourceOneDestination:
    @classmethod
    def create_data_widget(cls, mdi_area: QtWidgets.QMdiArea, extra_args: Dict[str, Any]) -> QtWidgets.QSplitter:
        """
        ...
        def _on_open(src_files: Sequence[str], new_tab: bool) -> None:
            ...
            for file_path in src_files:
                ...
                try:  # sometimes not all required data is there - so try
                    ...
                    MB.warning(
                        mdi_area, tr("Error"), "Error while opening {file_path}:"
        ...
        cls._source_widget = SingleFilesystemWidget(
            splitter, FilesystemTitle(
                ...
                new_action(splitter, 'folder', tr("Open Image"),
                           triggered=_on_open_src),
                new_action(splitter, 'folder', tr("Open Image in New Tab"),
        ...
        cls._destination_widget = SingleFilesystemWidget(
            splitter, FilesystemTitle(
                ...
                new_action(splitter, 'folder',
                           tr("Open Image Corresponding to Markup"),
                           triggered=_on_open_dst),
                new_action(splitter, 'eye_open', tr("View File"),
