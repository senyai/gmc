...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _setup_left_panel(self):
        left_frame = QtWidgets.QFrame(
            self._main_splitter,
            objectName="left_frame",
            frameShape=QtWidgets.QFrame.WinPanel,
    ...
    def _menu_button(self):
        ...
        schema_menu = main_menu.addMenu(
            get_icon("windows_list"), tr("&Schema")
        )
        ...
        language_menu = main_menu.addMenu(
            get_icon("cat"), tr("&Language / Язык")
        )
        ...
        main_menu.addAction(
            QtWidgets.QAction(
                ...
                tr("&About Qt"),
                self,
                triggered=self._on_about_qt,
                menuRole=QtWidgets.QAction.AboutQtRole,
            )
        )
        main_menu.addAction(
            QtWidgets.QAction(
    ...
    def _on_help(self):
        path = QtCore.QFileInfo(
            f"{__file__}/../../doc/build/html/index.html"
        ).absoluteFilePath()
    ...
    def _load_settings(self, lang: str) -> None:
        ...
        for action in actions:
            ...
            self._set_left_widget(HelpLabel(tr("Start by selecting a schema")))
